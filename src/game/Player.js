...
// Xbot.glb — 의상/텍스처 없이 단색 관절로만 이루어진 단순한 사람 형태 모델. idle/walk 애니메이션 내장.
const MODEL_URL = `${import.meta.env.BASE_URL}models/Xbot.glb`;
const MODEL_FACING_OFFSET = 0; // 모델의 정면축이 반대로 보이면 여기서 Math.PI로 180도 보정

/** Xbot.glb는 용량이 있어(약 2.9MB) 세션당 한 번만 받고 캐싱해 재사용한다 */
